...
class DealerServer : Script
{
    ...
    List<Client> currPlayers = new List<Client>();
    ...
    {
        Dealer playerDealer;
        if (currPlayers.Contains(player))
        {
    ...
    public void peekAtCards(Client sender)
    {
        ...
        if (currPlayers.Contains(sender) && allPlayers.TryGetValue(sender, out peekingPlayer))
        {
    ...
    public void leaveGame(Client sender)
    {
        ...
        if (currPlayers.Contains((sender)))
        {
    ...
    public void startAddPlayer(Client sender, Client target)
    {
        ...
        if (dealers.TryGetValue(sender, out d) && (target.exists && !(currPlayers.Contains(target))))
        {
